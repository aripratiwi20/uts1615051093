    ...
    return (
      <TouchableOpacity activeOpacity={0.7} style={styles.row}>
         ...
         <View style={styles.tulisan}>
          ...
          <Text style={styles.Title}>Kode Buku : {record.KodeBuku}</Text>
          <Text style={styles.Details}>Alamat : {record.alamat}</Text>
          <Text style={styles.Details}>Nomor Hp : {record.NoHP}</Text>
          </View>
         </View>
			...
			<ImageBackground
              ...
              <View style={styles.box}>
        			<Text style={styles.title}>Peminjaman Buku</Text>
       				<Text style={styles.subTitle}>Data Peminjaman</Text>
                <ListView
                  refreshControl={
                  <RefreshControl
